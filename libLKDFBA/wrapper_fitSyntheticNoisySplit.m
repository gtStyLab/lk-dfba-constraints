function wrapper_fitSyntheticNoisySplit(fileName,fitStringList)
    ...
    odeDataDir = 'SyntheticModel/SyntheticData/noisy_data';
    seriesName = sprintf('Synthetic Noisy Split');
    ...
    fprintf('Fitting %s...\n',fitOptions.odeFile)
    fitSynthetic(modelStruct,fitOptions,fitStringList,missingX,fitOptions.resultsFileStem)
