function [optimalParams,solverStatus,solverPopulation] = fitLKDFBA_UpDownReg(odeTimeVec,odeConcMatrix,odeFluxMatrix,modelStruct,dataWeightVector,fitOptions)
...
% Edits to prevent errors when predicting up/down regulation JL02Jan20
