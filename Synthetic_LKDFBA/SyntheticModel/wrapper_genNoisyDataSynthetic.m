function wrapper_genNoisyDataSynthetic(hiResDataFileName,nT,cov,numSets)
    ...
    loResDataFileNameStem = sprintf('%snoisy_data/%s_nT-%03d_cov-%02d_rep-',hiResDataFileName(1:slashidx),hiResDataFileName(slashidx+1:idxEnd(2)-1),nT,cov*100);
